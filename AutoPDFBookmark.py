...
!!! the 'font-size' in body CANNOT equal to the h1,h2,h3... styles, else will encounter error
'''
...
if __name__ == '__main__':
    ...
    doc = pymupdf.open(pdf_input_name)
                ...
                for key,values in  css_list.items():
                    ...
                    if match_obj: #get selector named hxxx
                        ...
                        if 'font-size' in values and 'font-family' in values: #only match font-size and font-family
                            ...
                            if match_obj and int(match_obj.group(1)) == round(context['size'], 1):
                                #pt1 = re.compile(re_chapter_code)
                                #mo = pt1.match(context['text'])
                                #if mo == None:
                                #    continue
                                print("    " * (bmk_level-1), context['text'], sep="")
                                line_local = context['bbox'][1]
                                point = pymupdf.Point(0, float(line_local))
